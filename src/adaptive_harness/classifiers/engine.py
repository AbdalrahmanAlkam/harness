...
SEMIF_DESCRIPTIONS = {
    ...
    "coding": "Implement, debug, refactor, and verify software code.",
    "research": "Review literature and evidence, compare sources, and synthesize cited findings.",
    "science": "Prove mathematics, analyze data, test numerical algorithms, and check convergence.",
    "audit": "Review software security, vulnerabilities, injection risks, and unsafe commands.",
    "none": "Deterministic reads, listings, git status, or trivial formatting with no reasoning.",
    "low": "A straightforward fix, simple function, or unit test needing light reasoning.",
    "medium": "Cross-module work, a data pipeline, or an algorithm requiring several steps.",
    "deep": "Concurrency bugs, system architecture, formal proofs, or complex security analysis.",
